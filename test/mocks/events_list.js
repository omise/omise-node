...
nock('https://api.omise.co')
  ...
  .reply(200, {
    ...
    'data':   [{
      ...
      'key':        'charge.create',
      'created_at': '2016-02-11T12:27:15Z',
      'data':       {
        'object':          'charge',
        ...
        'card':            {
          ...
          'created_at':          '2016-02-11T12:27:13Z',
        },
        'customer':   null,
        'ip':         null,
        'dispute':    null,
        'created_at': '2016-02-11T12:27:14Z',
      },
    }, {
      'object':     'event',
      ...
      'key':        'charge.create',
      'created_at': '2016-02-12T06:29:22Z',
      'data':       {
        'object':          'charge',
        ...
        'card':            {
          ...
          'name':                'JOHN DOE',
          'security_code_check': true,
          'created_at':          '2016-02-12T06:29:21Z',
        },
        'customer':   null,
        'ip':         null,
        'dispute':    null,
